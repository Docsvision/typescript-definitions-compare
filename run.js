...
(function (factory) {
    ...
    if (config.previous && config.next) {
        ...
        let oldNodes = [];
        load_nodes_1.loadNodes(srcOld, [], oldNodes, !config.previousFormat || config.previousFormat == "modules");
        let newNodes = [];
        load_nodes_1.loadNodes(srcNew, [], newNodes, !config.nextFormat || config.nextFormat == "modules");
        ...
        check_compability_1.checkCompability(oldNodes, newNodes, log, config.comparePaths !== false);
